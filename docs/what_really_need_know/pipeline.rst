...
Content:
  ...
  model preprocessing -> introduce PipelineCreator
  model types,
  hyperparameter (without tuning),
  link to examples?/one quick pipeline?,

So far we know how to pass input data to :func:`.run_cross_validation`. Now, we
wil have a look at the implementation of a basic machine learning pipeline.
...
So far we know how to input data. To do machine learning with these data 
...
====================================================
- add preprocessing to petal feature types only
